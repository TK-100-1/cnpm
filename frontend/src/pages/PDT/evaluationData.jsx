...
import { assessmentData, filterOptions } from '../../data/pdtData.js';
        ...
        <div className="assessment-container">
            ...
            <main className="assessment-main">
                ...
                <div className="filter-bar">
                    ...
                    <FilterDropdown title="Bộ môn" options={filterOptions.boMon} filterKey="boMon" onChange={handleFilterChange} />
            <FilterDropdown title="Mã môn" options={filterOptions.maMon} filterKey="maMon" onChange={handleFilterChange} />
            <FilterDropdown title="Lớp" options={filterOptions.lop} filterKey="lop" onChange={handleFilterChange} />
            <FilterDropdown title="Điểm TB" options={filterOptions.diemTB} filterKey="diemTB" onChange={handleFilterChange} />
            <FilterDropdown title="Học kỳ" options={filterOptions.hocKy} filterKey="hocKy" onChange={handleFilterChange} />
            <FilterDropdown title="Đánh Giá" options={filterOptions.danhGia} filterKey="danhGia" onChange={handleFilterChange} />
                </div>
